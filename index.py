...
class MainApp(QMainWindow, ui):
    ...
    def Handle_Buttons(self):
        ...
        #self.label_21.clicked.connect(self.Open_Search)
        ...
        self.pushButton_18.clicked.connect(self.about)

    def about(self):
        self.about_dialog = QDialog()
        self.about_dialog.setGeometry(0,0,678,318)
        self.aboutus_txt = QLabel("About us", self.about_dialog)
        self.aboutus_txt.setFont(QFont('Times', 21))
        self.aboutus_txt.setGeometry(QtCore.QRect(20, 20, 131, 31))
        self.aboutus_dis = QLabel(''' Job-Trend  \n Copyright (C) 2020  Jagadeesh\n\n      This program comes with ABSOLUTELY NO WARRANTY;\n      This is free software, and you are welcome to redistribute it\n      under certain conditions; See GNU General Public License for details.''', self.about_dialog)
        self.aboutus_txt.setFont(QFont('Times', 21))
        self.aboutus_dis.setGeometry(40,70,671,141)
        self.github = QLabel('Github:', self.about_dialog)
        self.license = QLabel('GPLV3+:', self.about_dialog)
        self.github.setGeometry(50,248,71,31)
        self.license.setGeometry(50,209,71,31)
        self.github.setFont(QFont('Times', 16))
        self.license.setFont(QFont('Times', 14))
        self.gitlink = QLabel(self.about_dialog)
        self.lic = QLabel(self.about_dialog)
        self.gitlink.setGeometry(130,250,421,31)
        self.lic.setGeometry(130,211,421,31)
        self.gitlink.setOpenExternalLinks(True)
        self.lic.setOpenExternalLinks(True)
        self.gitlink.setText("<a href='https://github.com/jagadeesh-tolnut/Future_job_trends'>https://github.com/jagadeesh-tolnut/Future_job_trends</a>")
        self.lic.setText("<a href='https://www.gnu.org/licenses/gpl-3.0.html'>https://www.gnu.org/licenses/gpl-3.0.html</a>")
